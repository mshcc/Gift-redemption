...
import com.siro.producer.security.JwtAuthenticationFilter;
import com.siro.producer.security.JwtAuthenticationProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //解决in a frame because it set 'X-Frame-Options' to 'deny'
